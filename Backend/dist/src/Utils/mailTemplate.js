...
exports.buildOtpTemplate = buildOtpTemplate;
...
function formatBodyText(value) {
    ...
    if (!trimmed)
        return "<p style=\"margin:0;color:#64748b;\">No message content provided.</p>";
...
function buildContactMessageTemplate(senderEmail, senderName, message) {
...
function buildOtpTemplate(recipientEmail, otp, expiresInMinutes) {
