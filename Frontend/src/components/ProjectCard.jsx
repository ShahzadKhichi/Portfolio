...
const ProjectCard = ({ Technologies, image, description }) => {
  return (
    <div className="border-2  flex flex-col my-4 hover:scale-105 active:scale-105 duration-300  shadow-2xl bg-[#080808f3]  border-[#2b2b2b] rounded-4xl py-4 items-center lg:w-[60%] ">
      <div className="w-full flex flex-col lg:flex-row">
        <div className=" w-full lg:h-[50vh] flex justify-center ">
          <img
            className=" w-[90%] rounded-4xl border-[1px]  shadow shadow-amber-50 border-amber-50"
            height={1100}
            src={image}
            alt=""
          />
