...
export default function Preloader() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-teal-accent/5 blur-3xl animate-pulse" />
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="w-20 h-20 rounded-full bg-teal-accent p-1 shadow-2xl shadow-teal-accent/30">
        ...
        {/* Progress Bar */}
        <motion.div
          className="w-64 h-1 bg-navy-800 rounded-full overflow-hidden"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        {[...Array(6)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-2 h-2 bg-teal-accent rounded-full blur-sm"
            animate={{
              x: [0, (i % 2 === 0 ? 1 : -1) * 100, 0],
              y: [0, -100, 0],
              opacity: [0, 1, 0],
